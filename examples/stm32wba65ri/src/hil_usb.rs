...
pub fn ready_msg() -> Msg<'static> {
    Msg::Ready {
        proto: PROTO_VERSION,
        model_id: MODEL_ID,
        input_len: ActiveModel::INPUT_DIM as u32,
        output_len: ActiveModel::OUTPUT_DIM as u32,
...
pub fn hello_acceptable(proto: u16, model_id: u32, input_len: u32, output_len: u32) -> Option<u16> {
    ...
    if input_len != 0 && input_len != ActiveModel::INPUT_DIM as u32 {
        return Some(NackCode::BadInputLen as u16);
    }
    if output_len != 0 && output_len != ActiveModel::OUTPUT_DIM as u32 {
        return Some(NackCode::BadInputLen as u16);
    }
    None
}
