...
//! Run with:
//! ```console
//! cargo run --example keyword_spotting --features="dsp,libm"
//! ```
...
static LAYER1_WEIGHTS: [i8; INPUT_FEATURES * HIDDEN_UNITS] = [
    // Pre-trained quantized weights pattern (3584 elements)
...
static LAYER2_WEIGHTS: [i8; HIDDEN_UNITS * NUM_CLASSES] = [
    -4, 1, 6, -3, 2, -5, 4, 1, -3, 5, 2, -4, 6, 1, -2, 5, -3, 4, 2, -5, 1, 6, -2, 4, -3, 5, 1, -4,
    6, 2, -3, 5, 1, -4, 5, -2, 6, 2, -3, 4, 1, -5, 6, 3, -2, 4, 1, -5, 6, 2, -4, 3, 1, -5, 4, 2, 6,
    -3, 1, 5, -2, 4, 6, -1, 2, 5, -3, 4, 1, -5, 6, 2, 3, -4, 5, 1, -2, 6, 4, -3, 5, 1, -4, 6, 2,
    -3, 5, 1, -2, 4, 6, -5, 3, 1, -4, 2, -2, 6, 1, -4, 5, 3, -2, 6, 4, 1, -5, 3, 2, -4, 6, 1, 5,
    -2, 4, 1, -3, 6, 2, -5, 4, 1, -2, 6, 3, 5, -4, 1,
];
...
fn main() {
    ...
    let in_dims = Dims {
        ...
        h: 1,
        w: 1,
        c: INPUT_FEATURES as i32,
    };
    let filter1_dims = Dims {
        n: INPUT_FEATURES as i32,
        h: 1,
        w: 1,
        c: HIDDEN_UNITS as i32,
    };
    let hidden_dims = Dims {
        n: 1,
        h: 1,
        w: 1,
        c: HIDDEN_UNITS as i32,
    ...
    let filter2_dims = Dims {
        n: HIDDEN_UNITS as i32,
        h: 1,
        w: 1,
        c: NUM_CLASSES as i32,
    };
    let out_dims = Dims {
        n: 1,
        h: 1,
    ...
    // Output Softmax Activation: 1 row of 4 classes
    softmax_s8(
        &arena_logits,
        1,
        NUM_CLASSES,
